<div class="theme-inner-banner">
	        	...
	        	<div class="row">
	        		<div class="col-md-6 col-sm-12 col-xs-12 wow fadeInLeft">
	        			<div class="contact-us-form">
	        				...
	        				<form action="http://html.unifytheme.com/fokir/inc/sendemail.php" class="form-validation" autocomplete="off">
	        					<div class="row">
	        						<div class="col-xs-12">
	        					...
	        					<button class="button-one ch-p-bg-color">Send Message</button>
	        				</form>
			...
			<div>
				<div id="google-map-area">
					<div class="google-map-three" id="contact-google-map" data-map-lat="40.925372" data-map-lng="-74.276544" data-icon-path="images/logo/map3.png" data-map-title="Find Map" data-map-zoom="12"></div>
		   		 </div>
